...
const PeopleTalkingSection = () => {
    return (
        <div className="sectionGap">
            <div>
                <h2 className="titleHeading text-center 2xl:pb-[50px] relative">
                ...
                <div className="2xl:grid 2xl:grid-cols-3 2xl:gap-[53px] overflow-hidden">
                    <div className="flex flex-col" >
                        ...
                        <Fade direction="left">
                            <div className="bg-[#F1f0f0] 2xl:rounded-[10px] ">
                                <div className="peopleCardParent">
                                    <div>
                                        <ImQuotesLeft className="2xl:text-[50px] text-[#E12026]"></ImQuotesLeft>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <div className="flex items-center 2xl:space-x-[15px]">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex 2xl:space-x-[2px]">
                                                    <IoIosStar className="2xl:text-[14px] text-yellow-500"></IoIosStar>
                                                    <IoIosStar className="2xl:text-[14px] text-yellow-500"></IoIosStar>
                                                    <IoIosStar className="2xl:text-[14px] text-yellow-500"></IoIosStar>
                                                    <IoIosStar className="2xl:text-[14px] text-yellow-500"></IoIosStar>
                                                    <IoIosStar className="2xl:text-[14px] text-yellow-500"></IoIosStar>
                        ...
                        {/* -------------card Four here ---------------- */}
                        <Fade direction="down">
                            <div className="bg-[#F1f0f0] 2xl:rounded-[10px] 2xl:mt-[50px]">
                                <div className="peopleCardParent">
                                    <div>
                                        <ImQuotesLeft className="2xl:text-[50px] text-[#E12026]"></ImQuotesLeft>
                                    </div>
